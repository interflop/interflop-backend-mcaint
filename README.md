...
```bash
VFC_BACKENDS="libinterflop_mca_int.so --help" ./test
test: verificarlo loaded backend libinterflop_mca_int.so
Usage: libinterflop_mca_int.so [OPTION...]
...
```bash
   $ VFC_BACKENDS="libinterflop_mca_int.so --mode=ieee" ./test
   0x0.fffffep-126 +0x1.000000p-149 = 0x1.000000p-126
   $ VFC_BACKENDS="libinterflop_mca_int.so --mode=ieee --daz" ./test
   0x0.fffffep-126 +0x1.000000p-149 = 0x0
   $ VFC_BACKENDS="libinterflop_mca_int.so --mode=ieee --ftz" ./test
   0x0.fffffep-126 +0x1.000000p-149 = 0x1.000000p-126
```
